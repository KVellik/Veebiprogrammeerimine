<?php
  ...
  //parooli kontroll (kas on olemas, kas vähemalt 8 tähte ja kaks korde ühtemoodi)
  ...
  if(empty($nameError) and  empty($surnameError) and empty($birthMonthError) and empty($birthYearError)and empty($birthDayError) and empty($birthDateError) and empty($genderError) and empty($emailError) and empty($confirmpasswordError)){
