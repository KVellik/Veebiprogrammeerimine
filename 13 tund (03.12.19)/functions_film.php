<?php
  ...
  function showFullDataByPerson(){
	  ...
	  $stmt = $conn->prepare("SELECT AMET.Nimetus, ISIK.Eesnimi, ISIK.Perekonnanimi, ISIK.Synniaeg, ISIK_FILMIS.Roll, FILM.Pealkiri, FILM.Aasta, FILM.Kestus, FILM.Sisukokkuvõte FROM ISIK JOIN ISIK_FILMIS ON ISIK.Isik_ID = ISIK_FILMIS.ISIK_Isik_ID JOIN FILM ON FILM.Film_ID = ISIK_FILMIS.FILM_Film_ID JOIN AMET ON ISIK_FILMIS.AMET_Amet_ID = AMET.Amet_ID");
	  echo $conn->error;
